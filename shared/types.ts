...
export type SupplyGrade = "S" | "A" | "B" | "C" | "D" | "NA";

export type AutonomousEvidenceSource =
  | "direct"
  | "text_heuristic"
  | "sample_only"
  | "unsupported";

export interface AutonomousRuleEvidence {
  key: string;
  label: string;
  value: string;
...
export interface AutonomousPoolDecision {
  pool: AutonomousPool;
  ...
  canEnterEntryScore: boolean;
  canEnterAlertScore: boolean;
  summary: string;
  keepReasons: string[];
...
export interface PreFilterDiagnostics {
  ...
  sampledFromFiltered: boolean;
  rejectReasonCounts: Record<string, number>;
  poolDistribution: Record<AutonomousPool, number>;
}
...
export interface ConfigResponse {
  ...
  maskedCsfloatApiKey: string | null;
  tokenSource: "runtime" | "env" | "none";
  csfloatApiKeySource: "runtime" | "env" | "none";
  watchlist: WatchlistEntry[];
...
export interface RecommendationCard {
  ...
  dataPoints: string[];
  triggerTags: string[];
  autonomousPool: AutonomousPoolDecision;
}
...
export interface RecommendationResponse {
  ...
  scanner: {
    ...
    preFilter?: PreFilterDiagnostics;
